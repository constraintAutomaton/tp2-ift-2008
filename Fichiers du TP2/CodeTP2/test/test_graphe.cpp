...
TEST_F(Studs2,ArcExisteInGraph)
{
    ...
    ASSERT_EQ(graph_1_Arc->arcExiste(source1,destination1),true);

    ASSERT_EQ(graph_1_Arc->arcExiste(source1,destination1),true);
    ASSERT_EQ(graph_2_Arc->arcExiste(source2,destination2),true);

    ASSERT_EQ(graph_n_Arc->arcExiste(source1,destination1),true);
    ASSERT_EQ(graph_n_Arc->arcExiste(source2,destination2),true);
    ASSERT_EQ(graph_n_Arc->arcExiste(source3,destination3),true);
    
}

TEST_F(Studs2,ArcExisteNotInGraph)
{
    ASSERT_EQ(graph_1_Arc->arcExiste(source3,destination3),false);
    ASSERT_EQ(graph_2_Arc->arcExiste(source3,destination3),false);
    ASSERT_EQ(graph_2_Arc->arcExiste(source4,destination4),false);
    ASSERT_EQ(graph_n_Arc->arcExiste(source5,destination5),false);
